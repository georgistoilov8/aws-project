...
import { AuthenticationRoutes } from './authentication/authentication.routes.config';
import ConnectionConfiguration from './connection/connection.config';
import { UploadRoutes } from './upload/upload.routes.config';
...
var connection = ConnectionConfiguration.connection
...
routes.push(new RetrieveRoutes(app));
routes.push(new UserActionsRoutes(app));
